...
RULES_PATH = Path("/Users/nazlidecker/ml-project/experiments/data_clean/config/cleaning_rules_v1.yaml")
...
def main():
    ...
    # keep numeric columns + time + targets
    ...
    manifest_path = Path("/Users/nazlidecker/ml-project/experiments/data_clean/manifests/dataset_v4_clean_manifest.json")
